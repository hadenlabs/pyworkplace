...
def test_send_generic_template():
    ...
    args = {
        ...
        'elements': [
            {
                'title': 'Title',
                'image_url': 'https://hadenlabs.com/image1.png',
                'subtitle': 'subtitle.',
                'default_action': {
                    'type': 'web_url',
                    'url': 'https://hadenlabs.com/item/103',
                    'messenger_extensions': True,
                    'webview_height_ratio': 'tall',
                    'fallback_url': 'https://hadenlabs.com/',
                },
                'buttons': [
                    {
                        'type': 'web_url',
    ...
    assert_that(
        message.send_generic_message(**args),
        not_none(),
    )
    body = {
        'message': {
...
def test_send_generic_template_multiple():
    ...
    args = {
        ...
        'elements': [
            ...
            {
                'title': 'Title2',
                'image_url': 'https://hadenlabs.com/image2.png',
                'subtitle': 'subtitle.',
                'buttons': [
                    {
                        'type': 'postback',
